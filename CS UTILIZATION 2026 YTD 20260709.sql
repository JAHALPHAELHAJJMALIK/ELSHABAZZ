...
-- =====================================================================
DECLARE @CSClockStart AS datetime2 = CAST('01/01/'+CAST(DATEPART(yyyy,GETDATE()) AS varchar(4)) AS datetime2)
DECLARE @CSClockStop AS datetime2 = TRY_CONVERT(date,EOMONTH(GETDATE(),0)) -- AS [EO CURRENT MONTH] -- EOMONTH ( start_date ,[ month_to_add ] ) ... '09/30/2023'
