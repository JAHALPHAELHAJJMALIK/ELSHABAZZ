...
-- C009: PALOMAR HEALTH MEDICAL GROUP 20260715 -- Contracting_Proposal_Category AND Proposed_Rate_Payment CASE BLOCKS HELD AT SAFE-STOP DEFAULT (NOT YET BUILT)
       /* Per Salim French (Director of Contract Administration) contracting request 20260702 (date brought to COO 20260702) -- Medi-Cal LOB AND Medicare LOB -- % of Medicare Fee Schedule basis
       Physical Therapy: current 100% of Medicare Fee Schedule -> proposed Y1 107% of Medicare Fee Schedule / Y2 110% of Medicare Fee Schedule (per user direction, only Y1 scaffolded; Y2 held pending effective/tier-change date)
       AWAITING SPECIFIC CPT/HCPCS CODE LIST FROM CONTRACTING -- request doc gives rate basis only, no code-level detail -- CASE blocks below intentionally left at safe-stop default (ELSE = 0 / 'Other Services') until codes are supplied; DO NOT activate without a confirmed code list
       Effective date requested by Provider: TBD | Variance $$/%%: TBD | Network Need: TBD | Comparable provider rates: TBD by Contracting
       Provider TIN: 27-1332228 | NPI: 1649500141 | DOS: 4/01/2025 - 3/30/2026 | Claims lag per request doc: 4/01/2025 (NOTE: matches DOS range start rather than a post-range cutoff -- flagged for Contracting confirmation) */
...
SET @leadlag = -15 -- RETAINED FOR REFERENCE/ROLLBACK ONLY -- NOT USED -- DATES HARDCODED BELOW PER C009
...
WHERE 1=1 
	AND -- C009: Rate Increase Request -- PALOMAR HEALTH MEDICAL GROUP (Physical Therapy) -- TIN: 27-1332228 NPI: 1649500141
	( -- INITIATE ...
...
ELSE 0 -- DEFAULT: uncategorized/awaiting-code lines are hard stop per corpus standard -- ALL Palomar lines route here until C009 code list is supplied
