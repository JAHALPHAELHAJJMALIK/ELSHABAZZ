...
SET @lobplanprog = 'MSO - CHPIV' -- SET @lobplanprog = 'DSNP MEDICARE PLAN' -- SELECT * FROM INFORMATICS.dbo.[uvw_LINE_OF_BUSINESS] -- ASSESS VALID ACTIVE OPTION(S)
...
FROM INFORMATICS.dbo.DHCS_LTC_CHPIV AS u
