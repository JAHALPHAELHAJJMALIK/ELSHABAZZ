...
WHERE 1=1
	...
	AND NOT EXISTS ( SELECT 1 FROM #AlgorithmPOF_MemberList# AS algo WHERE algo.memid = base.memid )

-- =====================================================================
	-- STEP2_RETAINED_FEWER_POFS -- IN BASELINE, IN >=1 EXISTING POF, STILL IN >=1 ALGORITHM POF --
-- =====================================================================
-- C002: NOT a disenrollment. Included to help reconcile JAG's 4000 expectation against DUB C 2.0 1000 estimate, this group lost SOME POF qualifications under the algorithm but did not lose ECM Enrolled status entirely
SELECT DISTINCT base.memid
,base.[DOE (Date of Entry)]
,base.MEMBER_AGE
,base.EnrollEffDate
