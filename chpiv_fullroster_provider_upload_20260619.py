...
# Script to UPLOAD Excel file to SQL Server - optimized FOR "CHPIV IPA_COMBINED_6.8.26.xlsx"
# DYNAMIC COLUMN READ ...
...
# UPDATE (2026-06-19): Modified file name, table name for June 2026 roster upload (IPA COMBINED file)
...
def stream_excel_to_sql(input_path, table_name, connection_string, batch_size=1000):
    ...
    # UPDATE HERE: NEW FILE NAME for CHPIV IPA COMBINED File - June 2026
    target_file = "CHPIV IPA_COMBINED_6.8.26.xlsx"
...
# ==============================================================================
    # Configuration - UPDATE HERE: CHPIV IPA COMBINED File specifications - June 2026
# ==============================================================================
input_path = r"C:\Users\wcarr\Desktop"

# UPDATE HERE: Fixed table name as specified - June 2026 update
table_name = "CHPIV_PROVIDER_DIRECTORY_DATA_UPDATE_20260619"
...
if __name__ == "__main__":
    print("=" * 100)
    print("CHPIV ROSTER IPA PROVIDER DIRECTORY UPLOAD SCRIPT - JUNE 2026 UPDATE")
    print("CHPIV IPA_COMBINED_6.8.26.xlsx to SQL Server")
    print("=" * 100)
    print(f"Source File: {os.path.join(input_path, 'CHPIV IPA_COMBINED_6.8.26.xlsx')}")
